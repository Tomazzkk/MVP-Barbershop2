...
export const BottomNav = () => {
  ...
  return (
    <motion.nav
      className="fixed bottom-4 inset-x-4 bg-black/80 backdrop-blur-lg border-2 border-primary/50 shadow-2xl shadow-primary/10 rounded-2xl z-50 md:bottom-6 p-1"
